...
window.__data = {
  ...
  fortune: {
    title: "おすすめアニメ占い",
    subtitle: "今日のキャラタイプと、今の気分に合う一本を引く",
    buttonLabel: "占う",
    retryLabel: "もう一回占う",
    characterTypes: [
      {
        name: "電脳ゴースト探偵",
        mood: "考えすぎるほど冴えている日",
        advice: "今日は難しい設定や哲学っぽい話が刺さる。情報量の多い作品を浴びると満足度が高い。",
        luckyTag: "電脳",
        tags: ["SF", "思索", "夜向き"],
      },
      {
        name: "空戦エース",
        mood: "勢いで突破できる日",
        advice: "細かいことは一旦置いて、疾走感とチーム感を楽しむのが吉。熱量で押し切れる。",
        luckyTag: "ミリタリー",
        tags: ["バトル", "チーム", "テンション高め"],
      },
      {
        name: "時間跳躍ラボメン",
        mood: "伏線に気づける日",
        advice: "会話の違和感や小物に注目すると楽しい。見返し系の作品を選ぶと発見がある。",
        luckyTag: "タイムリープ",
        tags: ["SF", "伏線", "考察"],
      },
      {
        name: "反逆ストラテジスト",
        mood: "作戦を立てると強い日",
        advice: "頭脳戦や駆け引きがハマる。今日は主人公の覚悟に引っ張られて気合いが入る。",
        luckyTag: "頭脳戦",
        tags: ["戦略", "覚悟", "ドラマ"],
      },
      {
        name: "涙腺代筆屋",
        mood: "静かな感情に弱い日",
        advice: "派手さより、丁寧な会話と余韻を選ぶとよい。油断すると普通に泣く。",
        luckyTag: "感動",
        tags: ["ドラマ", "余韻", "泣く"],
      },
      {
        name: "孤独系ギターヒーロー",
        mood: "陰のまま光れる日",
        advice: "共感できる不器用さが栄養になる。音楽ものや成長譚を選ぶと元気が戻る。",
        luckyTag: "音楽",
        tags: ["日常系", "成長", "ライブ"],
      },
      {
        name: "呪力ゴリ押し術師",
        mood: "派手な作画で回復する日",
        advice: "理屈よりも強い絵と強い戦闘を浴びるのが正解。テンポの速いバトルが合う。",
        luckyTag: "バトル",
        tags: ["アクション", "作画", "勢い"],
      },
      {
        name: "劇場IMAX巡礼者",
        mood: "大画面の記憶が恋しい日",
        advice: "スケールの大きい作品を選ぶと満たされる。音響と映像に全振りしてよい。",
        luckyTag: "IMAX",
        tags: ["映画館派", "映像美", "没入"],
      },
    ],
